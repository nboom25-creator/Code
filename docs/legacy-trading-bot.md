# Legacy: `src/trading_bot`

This is the original single-file autonomous agent that predates AegisQuant.
It still works and is still tested; its documentation is preserved here
unchanged. If you are looking for the current platform, see the
