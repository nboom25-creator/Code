...
The database URL always comes from ``AEGIS_DATABASE_URL`` via the application
settings, so migrations can never be applied to a different database than the one
