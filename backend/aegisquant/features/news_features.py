...
_POSITIVE = {
    "beats": 0.6, "beat": 0.6, "record": 0.5, "surge": 0.6, "soars": 0.7, "jumps": 0.5,
    "raises": 0.5, "raised": 0.5, "upgrade": 0.6, "upgraded": 0.6, "outperform": 0.5,
    "approval": 0.6, "approved": 0.6, "wins": 0.5, "win": 0.4, "awarded": 0.5,
    "expansion": 0.4, "expands": 0.4, "growth": 0.3, "accelerating": 0.5, "strong": 0.4,
    "profit": 0.3, "profitable": 0.5, "breakthrough": 0.6, "partnership": 0.35,
    "launch": 0.3, "launches": 0.3, "guidance": 0.1, "buyback": 0.4, "dividend": 0.2,
}
_NEGATIVE = {
    "miss": -0.6, "misses": -0.6, "missed": -0.6, "plunge": -0.7, "plunges": -0.7,
    "falls": -0.4, "slump": -0.6, "downgrade": -0.6, "downgraded": -0.6, "cuts": -0.5,
    "cut": -0.4, "lowered": -0.5, "warning": -0.5, "warns": -0.5, "probe": -0.6,
    "investigation": -0.65, "lawsuit": -0.5, "sued": -0.5, "recall": -0.6,
    "restatement": -0.85, "restate": -0.85, "fraud": -0.95, "delisting": -0.8,
    "bankruptcy": -0.95, "default": -0.7, "layoffs": -0.35, "resigns": -0.4,
    "departure": -0.3, "short seller": -0.6, "dilution": -0.45, "offering": -0.3,
    "subpoena": -0.7, "halt": -0.5, "halted": -0.5, "weak": -0.4, "decline": -0.35,
}
_UNCERTAIN = {
    "may", "could", "might", "uncertain", "unclear", "reportedly", "rumor", "rumour",
    "considering", "explores", "exploring", "potential", "possible", "weighs",
}
...
EVENT_KEYWORDS: dict[str, tuple[str, ...]] = {
    ...
    "corporate_action": ("merger", "acquisition", "acquires", "spin-off", "split", "buyback", "offering"),
